...
.PHONY: test proof proof-pure-planner run-pure-planner compare-lab6-hr compare-lab6-hr-adversarial compare-observation-policy-hr compare-semantic-observation-hr compare-semantic-matrix-hr run-planner compare-lab8 compare-lab8-hr validate-hr-challenges compile
