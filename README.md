...
เริ่มจาก Rules mode ซึ่งเร็วและเป็นค่า default:
...
Agent จะสร้างแผน, เรียก MCP, ตรวจ Observation, ผูก Evidence และแสดงคำตอบใน terminal
...
> สรุป: ผู้เรียนทั่วไปเริ่มที่ `make run-agent`; ถ้าต้องการดูความสามารถล่าสุดให้ใช้
> `make run-agent-shadow`; คำสั่ง `compare-*` มีไว้พิสูจน์/วัดผล ไม่ใช่การคุยกับ Agent
