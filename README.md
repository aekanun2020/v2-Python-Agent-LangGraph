...
OBSERVATION_ROUTING_MODE=shadow make run-pure-planner  # reviewer ไม่มีสิทธิ์ block
OBSERVATION_ROUTING_MODE=enforce make run-pure-planner # reviewer block high risk ได้
```
